...
public class Page_AjoutAssurance extends AjoutSkeleton {
    ...
    public Page_AjoutAssurance() {
        super();
        changeLabel("Ajout d'assurance");
        Page_AjoutTravaux.setFontForAllComponents(form, fontSize);
    ...
    public void fillFormWithFields() {
        ...
        Page_AjoutTravaux.setFontForAllComponents(form, (int) (fontSize * 1.3));
    }
    ...
    private JPanel addButtonPanel() {
        ...
        Page_AjoutTravaux.setFontForAllComponents(panel, (int) (fontSize * 1.3));
